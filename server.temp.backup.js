...
// Non-streaming chat for reliability
app.post('/chat', async (req, res) => {
  try {
    ...
    const rsp = await client.responses.create({
      ...
      input: [
        { role: 'system', c
cd ~/Desktop/mrwash-chat

# 1) Back up current server, then overwrite with a known-good version
cp server.js server.backup2.js
